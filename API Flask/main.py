...
def getRmbg(imageid):
    ...
    listApiKey = ["oojwAHHS4M9Ai5JWBP4gowBi","7QJzZY63de6zz4k4cw9cAjD3","QbUPtyqiCQc3reDPPKYCuWdB","TLc4rmVqhznwWuDMMgJq4rmg","RtDcZjgrTqesxnwxn1rtgFRk","QJst8oa2v15kDa4aGAFQcmCh"]
    global count
    count+=1
